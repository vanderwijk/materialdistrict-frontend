...
- **Claude leest dit bestand in `materialdistrict-frontend`** (`docs/materiaal-classificatie-regelboek.md`). De plugin-repo is privé; houd deze frontend-kopie als bron van waarheid voor Claude. Wijzigingen aan de norm landen hier (main), niet alleen in de private plugin.
