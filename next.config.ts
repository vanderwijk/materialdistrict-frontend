...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      //     Next puts the decoded segment in `x-next-cache-tags` and crashes
      //     (Sentry JAVASCRIPT-NEXTJS-12). Slugs renamed in WordPress.
      //     Prefer ASCII percent-encoded `source` paths — literal `₂` did
      //     not match on Vercel. Middleware also rewrites any leftover `₂`.
      // ------------------------------------------------------------------
      {
        source:
          '/article/living-building-material-converts-co%E2%82%82-into-stone-and-biomass/',
        destination:
      ...
      {
        source:
          '/article/low-cost-low-energy-co%E2%82%82-capture-unlocks-new-potential/',
        destination:
      ...
      {
        source:
          '/article/zurich-pioneers-next-generation-urban-co%E2%82%82-monitoring/',
        destination:
      ...
      {
        source:
          '/article/turning-co%E2%82%82-into-solar-fuels-new-material-breakthroughs-with-design-potential/',
        destination:
      ...
      {
        source:
          '/article/modular-circular-culvert-reduces-co%E2%82%82-and-enables-reuse/',
        destination:
      ...
      {
        source:
          '/article/reusable-brick-walls-enable-circular-construction-with-up-to-60-lower-co%E2%82%82-emissions/',
        destination:
      ...
      {
        source:
          '/article/bacterial-factories-turn-co%E2%82%82-into-feedstock-for-sustainable-materials/',
        destination:
      ...
      {
        source:
          '/article/concrete-as-a-carbon-sink-co%E2%82%82-binding-cement-substitute-aims-to-transform-construction/',
        destination:
      ...
      {
        source:
          '/article/co%E2%82%82-to-carbon-process-advances-towards-industrial-application/',
        destination:
